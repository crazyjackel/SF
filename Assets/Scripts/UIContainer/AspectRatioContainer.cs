...
namespace GallantGames.UI
{
	...
	public class AspectRatioPanel : VisualElement
	{
		...
		{
			readonly UxmlIntAttributeDescription aspectRatioX = new UxmlIntAttributeDescription() { name = "aspect-ratio-x", defaultValue = 16, restriction = new UxmlValueBounds { min = "1" } };
			readonly UxmlIntAttributeDescription aspectRatioY = new UxmlIntAttributeDescription() { name = "aspect-ratio-y", defaultValue = 9, restriction = new UxmlValueBounds { min = "1" } };
			readonly UxmlIntAttributeDescription balanceX = new UxmlIntAttributeDescription() { name = "balance-x", defaultValue = 50, restriction = new UxmlValueBounds { min = "0", max = "100" } };
			readonly UxmlIntAttributeDescription balanceY = new UxmlIntAttributeDescription() { name = "balance-y", defaultValue = 50, restriction = new UxmlValueBounds { min = "0", max = "100" } };
